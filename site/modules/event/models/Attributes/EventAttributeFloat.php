...
/**
 * This is the model class for table "tbl_event_attribute_float".
 *
 * @property integer $id
 ...
 */
class EventAttributeFloat extends \app\modules\event\components\AttributeType {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return '{{%event_attribute_float}}';
    }

...
class Image
{
    ...
    {
        if (! class_exists('\app\components\image\ImageCache')) {
        ...
        $imagecache = new \app\components\image\ImageCache;
    ...
    {
        $obj = is_a($source, 'app\components\image\Image') ? $source : (new Image($source));
    ...
    public function mask($source, $mask_with_alpha = false)
    {
        ...
        // create mask
        $mask = is_a($source, 'app\components\image\Image') ? $source : (new Image($source));
    ...
    {
        if (is_a($source, 'app\components\image\Image')) {
    ...
    {
        $font = new \app\components\image\Font($text);

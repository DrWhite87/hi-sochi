...
```php
echo \app\components\extentions\imperavi\Widget::widget([
    'settings' => [
        'lang' => 'ru',
        'minHeight' => 200,
        'pastePlainText' => true,
...
```php
use app\components\extentions\imperavi\Widget;
...
public function actions()
{
    return [
        'get' => [
            'class' => 'app\components\extentions\imperavi\actions\GetAction',
...
public function actions()
{
    return [
        'image-upload' => [
            'class' => 'app\components\extentions\imperavi\actions\UploadAction',
            'url' => 'http://my-site.com/images/', // Directory URL address, where files are stored.
